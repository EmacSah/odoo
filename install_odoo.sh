...
# 14. Vérification de l'état des services
echo "Vérification des services..."
sudo docker ps && success "Services Odoo et PostgreSQL actifs."

# 15. Désactivation du pare-feu
echo "Désactivation du pare-feu (si nécessaire)..."
sudo ufw disable && success "Pare-feu désactivé."



# 16. Test du port HTTP
